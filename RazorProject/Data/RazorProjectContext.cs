...
namespace RazorProject.Data
{
    public class RazorProjectContext : DbContext
    {
        ...
        public DbSet<RazorProject.Models.Project> Project { get; set; } = default!;

        public DbSet<RazorProject.Models.Epic>? Epic { get; set; }

        public DbSet<RazorProject.Models.Task>? Task { get; set; }

        public DbSet<RazorProject.Models.Employee>? Employee { get; set; }
