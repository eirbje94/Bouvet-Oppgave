...
namespace SwaggerProject.Controllers
{
    ...
    public class EpicsController : ControllerBase
    {
        ...
        public EpicsController(SwaggerProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Epic>>> GetEpic()
        {
          if (_context.Epic == null)
          {
            ...
            return await _context.Epic.Include(e => e.Project).Include(e => e.Tasks).ToListAsync();
        }
        ...
        public async Task<ActionResult<Epic>> GetEpic(int id)
        {
          if (_context.Epic == null)
          {
            ...
            var epic = await _context.Epic.Include(e => e.Project).ThenInclude(e => e.ProjectManager).Include(e => e.Tasks).ThenInclude(e => e.Responsible).FirstOrDefaultAsync(i => i.EpicId == id);
        ...
        public async Task<ActionResult<Epic>> PostEpic(Epic epic)
        {
          if (_context.Epic == null)
          {
              return Problem("Entity set 'SwaggerProjectContext.Epic'  is null.");
          }
