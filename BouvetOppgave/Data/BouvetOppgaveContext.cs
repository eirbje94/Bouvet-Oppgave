...
namespace BouvetOppgave.Data
{
    public class BouvetOppgaveContext : DbContext
    {
        public BouvetOppgaveContext (DbContextOptions<BouvetOppgaveContext> options)
            : base(options)
        {
        }

        public DbSet<BouvetOppgave.Models.Employee> Employee { get; set; } = default!;

        public DbSet<BouvetOppgave.Models.Project>? Project { get; set; }

        public DbSet<BouvetOppgave.Models.Epic>? Epic { get; set; }

        public DbSet<BouvetOppgave.Models.Task>? Task { get; set; }
